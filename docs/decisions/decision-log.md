...
*Cập nhật gần nhất: agent **A04.1** (D-2026-04-14-01 — dev `kitchen-done` + làm sạch tài liệu SoT); **A04** (D-2026-04-13-01); **A01.6** (D-16–D-19); A01.5 (stack + design workflow); A01 (giao thức `v1`).*
