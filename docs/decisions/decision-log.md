...
*Cập nhật gần nhất: agent **A05.2** (D-2026-04-13-03 — `pic_ingress`); **A05.1** (D-2026-04-13-02); **A04.1** (D-2026-04-14-01); **A04** (D-2026-04-13-01); **A01.6** (D-16–D-19); A01.5 (stack + design workflow); A01 (giao thức `v1`).*
