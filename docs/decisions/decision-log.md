...
*Cập nhật gần nhất: agent **A05.1** (D-2026-04-13-02 — dev `counter-paid` + E2E local); **A04.1** (D-2026-04-14-01 — dev `kitchen-done`); **A04** (D-2026-04-13-01); **A01.6** (D-16–D-19); A01.5 (stack + design workflow); A01 (giao thức `v1`).*
